...
public class TutorialPageFour extends Fragment {
    private static final String EXTRA_MESSAGE = "mes";

    public static final TutorialPageFour newInstance(String message ){
        TutorialPageFour f = new TutorialPageFour();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.item3, container, false);
